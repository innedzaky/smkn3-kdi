    ...
    <main className="content-page">
      ...
      <section>
        <div className="section-inner">
          <div
            className="jurusan-cover jurusan-cover-tall"
            style={{ backgroundImage: `url('${jurusan.gambar_url}')` }}
          >
              ...
              <div className="galeri-full-grid" style={{ marginBottom: "2.5rem" }}>
                {kegiatan.map((item) => (
                  <div className="galeri-card" key={item.id}>
                    <div className="galeri-img" style={{ backgroundImage: `url('${item.foto}')` }} />
              ...
              <div className="jurusan-guru-grid" style={{ marginBottom: "2.5rem" }}>
                {guru.map((g) => (
                  <div className="jurusan-guru-card" key={g.id}>
                    <div className="jurusan-guru-photo" style={{ backgroundImage: `url('${g.foto || ""}')` }} />
                    <h4>{g.nama}</h4>
